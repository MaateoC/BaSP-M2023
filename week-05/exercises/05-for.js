...
var firstArray = ["hello", "lets", "code", "right", "now"];
...
var secondArray = ["hello", "lets", "code", "right", "now"];
for(let index = 0; index < secondArray.length; index++){
    secondArray[index]= secondArray[index][0].toUpperCase()+ secondArray[index].substring(1);
    alert(secondArray[index]);
}
...
var words2 = ["hello", "lets", "code", "right", "now"];
let sentence = "";
